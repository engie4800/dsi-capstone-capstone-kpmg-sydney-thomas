...
class Tool:
    ...
    def __init__(self):
        self.api = "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"   
    def reset(self):
        pass 
...
class Chat:
    ...
    def __call__(self, question):
        ...
        if classified_tool == "ExtractionTool":
            ...
            query = self.exTool.generated_cypher
            result = self.ansSmoother(question, result)
